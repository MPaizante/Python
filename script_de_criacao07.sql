...
CREATE TABLE IF NOT EXISTS `aula07`.`tipocliente` (
  ...
  `s_dsctipocliente_tipocliente` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `aula07`.`cliente` (
  ...
  `i_tipocliente_cliente` INT NULL,
  PRIMARY KEY (`i_cliente_cliente`),
  INDEX `fk_cliente_tipocliente_idx` (`i_tipocliente_cliente` ASC) VISIBLE,
  CONSTRAINT `fk_cliente_tipocliente`
    FOREIGN KEY (`i_tipocliente_cliente`)
